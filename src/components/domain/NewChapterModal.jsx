...
const NewChapterModal = ({ isOpen, onClose, onSave }) => {
  ...
  const [marinesCount, setMarinesCount] = useState(1);
  ...
  const handleSubmit = (e) => {
    ...
    onSave({ 
      ...
      marinesCount: Number(marinesCount),
      world: world
    });
    onClose();
  };
            ...
            <div class="p-4 space-y-2">
              ...
              <div class="mb-4">
                ...
                <input
                  ...
                  type="text"
                  value={parentLegion}
                  onChange={(e) => setParentLegion(e.target.value)}
                  required
                />
                ...
                <input
                  ...
                  type="number"
                  value={marinesCount}
                  onChange={(e) => setMarinesCount(e.target.value)}
                  required
                />
